...
<?php if (!isset($_COOKIE['cookie_consent'])): ?>
    <div id="cookieBanner"
        ...
        <p style="margin: 0 0 15px 0; font-size: 16px;">Ce site utilise des cookies pour améliorer votre expérience.
            Acceptez-vous ?</p>
        <button onclick="setCookieConsent('accept')"
            style="background-color: #4CAF50; color: white; border: none; padding: 10px 20px; font-weight: bold; cursor: pointer; margin-right: 10px; border-radius: 5px;">Accepter</button>
        <button onclick="setCookieConsent('reject')"
            style="background-color: #f44336; color: white; border: none; padding: 10px 20px; font-weight: bold; cursor: pointer; border-radius: 5px;">Refuser</button>
    </div>
    <script>
